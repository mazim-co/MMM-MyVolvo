Module.register("MMM-MyVolvo", {
  defaults: {
    ...
    icons: {    
      ...
      "Average speed": `<span class="iconify" data-icon="bi:speedometer2"></span> `,
      "Odometer": `<span class="iconify" data-icon="healthicons:paved-road-outline"></span> `,
      "Departure": `<span class="iconify" data-icon="gis:route-start"></span> `,
  ...
  getDom: function() {
    ...
    if (this.config.display.notice) {
      ...
      var list = [
        "Door lock", "Heater", "Tyre",  "Tailgate", "Washer fluid",
